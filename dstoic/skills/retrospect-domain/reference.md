...
### Research Domain
Load from `${CLAUDE_PLUGIN_ROOT}/reference/domain-research.md` if available.
...
- **Extract, don't invent**: Base insights on actual session content
- **Be specific**: Reference actual conversations, tools used, decisions
- **Detect patterns**: Look for themes across multiple sessions
- **Domain-appropriate**: Use domain frameworks for deeper insights
- **Framework flexibility**: Adapt to session content type
