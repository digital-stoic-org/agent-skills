...
> 📦 **Cross-plugin skills**: This catalog covers skills across all plugins. **Total: 128 skills across 16 plugins, 2 agents** — but only ~12 run daily; the rest are parachutes or an archive of exploration. See [README.md](README.md) for the plugin table with per-plugin skill counts.
